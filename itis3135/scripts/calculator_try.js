window.onload = function () {
  ...
  sevenButton.onclick = () => appendToResult('7');
  eightButton.onclick = () => appendToResult('8');
  nineButton.onclick = () => appendToResult('9');
  ...
  oneButton.onclick = () => appendToResult('1');
  twoButton.onclick = () => appendToResult('2');
  threeButton.onclick = () => appendToResult('3');
